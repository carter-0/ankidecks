...
export default function FreeAccountBannerCTA() {
    return (
                    ...
                    <div className="flex items-center justify-between flex-wrap">
                        <div className="w-0 flex-1 flex items-center">
                            <p className="ml-3 font-medium text-white truncate">
                                <span className="md:hidden">You&apos;re still on a free account!</span>
                                <span className="hidden md:inline">Quick Reminder! You&apos;re still on a free account</span>
                            </p>
                        </div>
