                    ...
                    <div className="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
                        <div className="lg:self-center">
                            ...
                            <div className={"flex mt-8 items-center w-full sm:w-auto flex-col sm:flex-row"}>
                                <Link
                                    href="/new-deck"
                                    className="hover:outline-black hover:outline hover:outline-1 w-full sm:w-auto transition-transform duration-200 bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 rounded-md shadow px-5 py-3 inline-flex items-center text-base font-medium text-white hover:bg-teal-50"
                                >
                                    Make my deck
                                </Link>
